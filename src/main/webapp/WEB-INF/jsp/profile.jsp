...
<html>
    ...
    <body>
		...
		<section>
        	<div class="container py-5">
				<div class="card" style="width: 18rem; margin: auto;">
				  ...
				  <img src="assets/img/${user.profileImage}" class="card-img-top img-fluid" width="100%" height="20rem">
				  </c:if>
				  <div class="card-body">
        ...
        <section>
        	<div class="container py-5">
        		<form:form action="/profile" method="post" modelattribute="user" enctype="multipart/form-data">
        		<div class="row col-4" style="margin: auto;">
        			...
        			<div class="form-group mt-3">
					  ...
					  <input class="form-control" type="file" name="imgFile" id="imageFile" aria-describedby="imgHelp">
